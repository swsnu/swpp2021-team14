...
import WorkoutAdd from './WorkoutAdd.js'
...
describe("Test <WorkoutAdd/>", () => {
    ...
    it("should render without error", () => {
        const component = mount(workoutAdd);
    ...
    it("should render correct number of muscleTypeIcons", () => {
        ...
        neck.simulate('click');
        const instance = component.find(WorkoutAdd.WrappedComponent).instance()
